class: Workflow
cwlVersion: v1.0
id: tin_jasmine_v1_4_vep102
doc: TinJasmine germline variant caller with VEP v102 annotation
label: TinJasmine 1.4 VEP 102
inputs:
  - id: bam
    type: File
  - id: reference
...
outputs:
  ...
  - id: all_call_vcf
    outputSource:
      vep_annotate_tin_jasmine_v102/output_dat
    type: File
steps:
  ...
  - id: canonical_filter
    in:
      - id: VCF_A
        source: vep_annotate_tin_jasmine_v102/output_dat
      - id: BED
